...
public class LoginSecurityUtils {
    ...
    public void incrementLoginAttempts(String username) {
        String key = UserCenterCacheConstants.LoginSecurity.LOGIN_ATTEMPT_PREFIX + username;
    ...
    public void lockAccount(String username) {
        String lockKey = UserCenterCacheConstants.LoginSecurity.ACCOUNT_LOCK_PREFIX + username;
