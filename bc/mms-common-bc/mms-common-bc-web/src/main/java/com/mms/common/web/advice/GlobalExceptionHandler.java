...
public class GlobalExceptionHandler {
    ...
    public Response<?> handleBusinessException(BusinessException e) {
        if (e.getMessage() == null) {
            ...
            return Response.fail(e.getErrorCode().getCode(), e.getErrorCode().getMsg());
        } else {
            // 处理自定义业务异常消息
            log.warn("业务异常: 【{}】", e.getMessage());
            return Response.fail(e.getErrorCode().getCode(), e.getMessage());
        }
    }
    ...
    public Response<?> handleServerException(ServerException e) {
        ...
        return Response.error(HttpStatus.INTERNAL_SERVER_ERROR.value(), ErrorCode.SYSTEM_ERROR.getMsg());
    }
    ...
    public Response<?> handleHttpMessageNotReadableException(HttpMessageNotReadableException e) {
        ...
        return Response.error(HttpStatus.BAD_REQUEST.value(), ErrorCode.PARAMETER_PARSING_EXCEPTION.getMsg());
    }
    ...
    public Response<?> handleNotFound(NoHandlerFoundException e) {
        ...
        return Response.error(HttpStatus.NOT_FOUND.value(), ErrorCode.RESOURCE_NOT_EXIST.getMsg());
    }
    ...
    public Response<?> handleMethodNotAllowed(HttpRequestMethodNotSupportedException e) {
        ...
        return Response.error(HttpStatus.METHOD_NOT_ALLOWED.value(), ErrorCode.METHOD_MISMATCH.getMsg());
    }
